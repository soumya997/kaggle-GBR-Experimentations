...
get_ipython().system('mkdir -p ./yolo_data/fold2/images/val')
get_ipython().system('mkdir -p ./yolo_data/fold2/images/train')

get_ipython().system('mkdir -p ./yolo_data/fold2/labels/val')
get_ipython().system('mkdir -p ./yolo_data/fold2/labels/train')
...
print("total training samples", len(os.listdir("./yolo_data/fold2/labels/train")))
...
get_ipython().system('mkdir /kaggle/working/yolov5')
get_ipython().system('cp -a ../input/yolov5m6try1-video-foldvid-id2img3ke11bs2/yolov5/. /kaggle/working/yolov5')
...
get_ipython().system('python train.py     --resume /kaggle/working/yolov5/runs/train/M6_base_vid_2val/weights/last.pt     --epochs 11     --save-period 1')
