...
get_ipython().system('python train.py     --img 3584     --batch 2     --epochs 11     --optimizer Adam     --data data/reef_f1_naive.yaml     --weights yolov5s6.pt     --name base_vid_2val     --hyp data/hyps/hyp.heavy.2.yaml     --save-period 1')
