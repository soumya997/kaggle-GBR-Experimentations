...
get_ipython().system('python train.py     --img 3000     --batch 2     --epochs 11     --data data/reef_f1_naive.yaml     --weights yolov5m6.pt     --name M6_base_vid_2val     --hyp data/hyps/hyp.heavy.2.yaml     --save-period 1')
...
get_ipython().system('rm -r /kaggle/working/yolo_data')
