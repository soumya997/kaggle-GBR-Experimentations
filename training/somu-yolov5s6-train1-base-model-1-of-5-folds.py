...
get_ipython().system('python train.py     --img 3000     --batch 2     --epochs 11     --data data/cots.yaml     --cfg yolov5s.yaml     --weights yolov5s6.pt     --name cots_with_albs     --hyp data/hyps/hyps_custom.yaml     --save-period 1')
