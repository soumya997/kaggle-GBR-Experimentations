...
get_ipython().system('python train.py     --img 640     --batch 2     --epochs 1     --data data/reef_f1_naive.yaml     --weights yolov5m6.pt     --name base_vid_2val     --hyp data/hyps/hyp.heavy.2.yaml     --save-period 1')
